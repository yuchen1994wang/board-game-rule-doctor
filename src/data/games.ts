...
export const games: GameRule[] = [
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/en/thumb/1/1d/Brass_Birmingham_cover.jpg/220px-Brass_Birmingham_cover.jpg',
    hasExpansions: false,
    category: ['德式'],
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/Durian_Fruit.jpg/220px-Durian_Fruit.jpg',
    hasExpansions: false,
    category: ['聚会'],
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/en/thumb/2/2b/Terra_Mystica_cover.jpg/220px-Terra_Mystica_cover.jpg',
    hasExpansions: false,
    category: ['德式'],
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/5a/Modern_Art_board_game.jpg/220px-Modern_Art_board_game.jpg',
    hasExpansions: false,
    category: ['聚会'],
    mechanism: ['拍卖', '手牌管理'],
    setup: [
