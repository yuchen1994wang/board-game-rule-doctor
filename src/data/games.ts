...
export const games: GameRule[] = [
  ...
  },
  {
    ...
    name: '文艺复兴的贵族们',
    nameEn: "Lorenzo il Magnifico",
    description: '意大利文艺复兴时期家族发展策略桌游',
    playerCount: '2-4人',
    weight: 3.4,
    background: '《文艺复兴的贵族们》(Lorenzo il Magnifico) 是由 Flaminia Brasini、Virginio Giglio 和 Simone Luciani 设计的经典德式策略游戏，于2016年由 Cranio Creations 出版。游戏背景设定在15世纪的意大利佛罗伦萨文艺复兴时期，玩家扮演贵族家族的首领，通过派遣家族成员到各种行动地点来获取资源、建造建筑、发展领土、招募人物，最终获得最多的声望分数。游戏的核心机制是骰子驱动的工人放置，每轮掷出的骰子点数决定了玩家可以执行的行动强度。玩家需要巧妙利用领袖卡的特殊能力，合理规划家族成员的行动，在有限的回合内最大化家族的发展。作为 Simone Luciani 的代表作之一，它以其精美的美术、深度的策略和丰富的重玩价值著称，被誉为文艺复兴主题桌游的巅峰之作。',
    image: '/images/lorenzo-il-magnifico.jpg',
    hasExpansions: true,
    category: ['德式'],
    mechanism: ['骰子驱动', '工人放置', '资源管理', '引擎构筑'],
    setup: [
      {
        playerCount: '2-4人',
        steps: [
          '摆放主游戏板（行动区域、市场、教堂、领地等）',
          '每位玩家获得1块玩家版图和3个家族成员（不同颜色）',
          '每位玩家获得2张领袖卡，选择1张保留',
          '放置资源token到供应区（木材、石材、金币、信仰、军事、仆人）',
          '将发展卡按时代分为3堆（I/II/III时代）',
          '翻开4张领地卡、4张人物卡、4张建筑卡到对应区域',
          '每位玩家获得起始资源（根据领袖卡不同）',
          '将回合标记放到第1轮位置',
          '决定起始玩家'
        ]
    ...
    turnActions: {
      onYourTurn: [
        '派遣家族成员：将1个家族成员放到行动区域（消耗对应颜色的骰子点数）',
        '执行行动：根据放置位置获得对应资源和效果',
        '市场行动：获取资源或转换资源',
        '领地行动：获得领地卡并放置到玩家版图',
        '建筑行动：支付资源建造建筑并获得分数',
        '人物行动：支付资源招募人物卡获得持续效果',
        '教堂行动：支付信仰获得教皇恩宠和分数',
        '军事行动：获得军事力量用于终局计分',
        '使用领袖能力：每轮可使用1次领袖特殊能力'
      ],
      outsideYourTurn: [
        '观察其他玩家的行动选择',
        '注意被占用的行动位置（每个位置限1人）',
    ...
    endConditions: [
      '完成6大轮（每轮包含2个小轮）后游戏结束',
      '第III时代的发展卡全部拿完后，完成当前轮后结束'
    ],
    scoring: {
      duringGame: [
        '建造建筑时获得即时分数',
    ...
    tokens: [
      { name: '家族成员', description: '每位玩家3个，代表可派遣的工人，颜色对应不同骰子' },
      { name: '骰子', description: '3颗家族骰子+1颗白色中立骰子，决定行动强度' },
      { name: '资源token', description: '木材、石材、金币、信仰、军事、仆人等6种资源' },
      { name: '领袖卡', description: '游戏开始时选择，提供独特能力和起始资源' },
      { name: '领地卡', description: '放置在玩家版图上，提供分数和资源产出' },
      { name: '建筑卡', description: '支付资源建造，提供分数和特殊效果' },
      { name: '人物卡', description: '支付资源招募，提供持续能力或终局计分' },
      { name: '教皇恩宠标记', description: '在恩宠轨道上移动，终局提供分数' },
      { name: '回合标记', description: '追踪当前游戏轮次（共6大轮）' }
    ],
    cards: [
      { name: '领地卡', count: 24, category: '领地牌', description: 'I/II/III时代各8张，提供领土和分数', value: 1 },
      { name: '建筑卡', count: 24, category: '建筑牌', description: 'I/II/III时代各8张，提供建筑和效果', value: 2 },
      { name: '人物卡', count: 24, category: '人物牌', description: 'I/II/III时代各8张，提供能力和计分', value: 3 },
      { name: '领袖卡', count: 4, category: '领袖牌', description: '4张可选领袖，提供独特能力', value: 4 }
    ]
  }
]
