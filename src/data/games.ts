...
export const games: GameRule[] = [
  ...
  },
  {
    ...
    image: 'https://cf.geekdo-images.com/img/3490053/repv1.jpg',
    hasExpansions: false,
    category: ['德式'],
  ...
  },
  {
    ...
    image: 'https://cf.geekdo-images.com/img/5866197/repv1.jpg',
    hasExpansions: false,
    category: ['聚会'],
  ...
  },
  {
    ...
    image: 'https://cf.geekdo-images.com/img/3544990/repv1.jpg',
    hasExpansions: true,
    category: ['德式'],
    mechanism: ['手牌管理', '引擎构筑'],
    setup: [
  ...
  },
  {
    ...
    image: 'https://cf.geekdo-images.com/img/7146967/repv1.jpg',
    hasExpansions: false,
    category: ['德式'],
  ...
  },
  {
    ...
    image: 'https://cf.geekdo-images.com/img/893687/repv1.jpg',
    hasExpansions: false,
    category: ['聚会'],
    mechanism: ['拍卖', '手牌管理'],
    setup: [
